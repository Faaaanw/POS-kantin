            ...
            <div class="container">
                <div class="menu-header">
                    ...
                    <div class="menu-title-container" style="text-decoration: none;">
                        <h1 class="menu-title" style="text-decoration: none;">User Management</h1>
                    </div>
                ...
                <div class="admin-container">
                    ...
                    <button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#userModal"
                        onclick="openCreateModal()">Tambah User</button>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <small id="passwordNote" class="text-muted">Isi jika ingin mengganti
                                            password</small>
                                    </div>
                                    <div class="mb-2">
                                        <label>Role</label>
